...
Before you consider the revision done, verify all of the following:

1. Every deviation is corrected at its source — the revised language fully restores conformance with the violated block, not just its surface wording.
2. Nothing outside the scope of the corrections changed; conforming provisions, numbering, and drafting style are intact.
